...
class densemat():
    ...
    @typing.overload
    def getvalues(self, values: list) -> None: ...
    def print(self) -> None: ...
...
class mat():
    ...
    def countrows(self) -> int: ...
    def eliminate(self, vecb: vec) -> vec: ...
    def getacols(self) -> indexmat: ...
    def getainds(self) -> indexmat: ...
    def getarows(self) -> indexmat: ...
    def getavals(self) -> densemat: ...
    def getdcols(self) -> indexmat: ...
    def getdinds(self) -> indexmat: ...
    def getdrows(self) -> indexmat: ...
    def getdvals(self) -> densemat: ...
    def print(self) -> None: ...
